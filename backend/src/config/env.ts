...
const envSchema = z.object({
  ...
  SEMANTIC_SEARCH_MODE: z.enum(["local", "atlas_vector"]).default("local"),
  ATLAS_VECTOR_INDEX_NAME: z.string().default("document_chunk_vector_idx"),
  SEMANTIC_NUM_CANDIDATES: z.coerce.number().int().positive().default(120),
  SEMANTIC_FALLBACK_SCAN_LIMIT: z.coerce.number().int().positive().default(500),
